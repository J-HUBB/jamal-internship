        ...
        <div className="row">
          <div className="col-lg-4 col-md-6 mb-sm-30">
            <div className="feature-box f-boxed style-3">
              ...
              <div className="text">
                <h4 data-aos="fade-up" data-aos-duration="1000">Set up your wallet</h4>
                <p
          ...
          <div className="col-lg-4 col-md-6 mb-sm-30">
            <div className="feature-box f-boxed style-3">
              ...
              ></i>
              <div className="text">
                <h4 data-aos="fade-up" data-aos-duration="1000">Add your NFT's</h4>
          ...
          <div className="col-lg-4 col-md-6 mb-sm-30">
            <div className="feature-box f-boxed style-3">
              ...
              <div className="text">
                <h4 data-aos="fade-up" data-aos-duration="1000" data-aos-ease="ease-in" >Sell your NFT's</h4>
                <p data-aos="fade-up" data-aos-duration="1000" data-aos-delay="250" >
                  Sed ut perspiciatis unde omnis iste natus error sit voluptatem
                  accusantium doloremque laudantium, totam rem.
                </p>
